<template>
    <section class="d-flex flex-column align-items-center justify-content-start col-12" id="_sec4_">
        <div class="__titre__ col-12 text-center mt-5">
            Ce que je propose
        </div>
        <div class="mt-3 col-12 mt-2 d-flex justify-content-center">
            <div class="col-11 col-md-6 d-flex flex-column align-items-start justify-content-start">
